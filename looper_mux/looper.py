...
class Looper():
    ...
    def setTurnadoDictatorLevel(self, turnado_dictator_level):        
        plugins.setParamValue(turnado_dictator_level, constants.TURNADO_DICTATOR_PARAM_INDEX, self.__looper_channel, constants.LOOPER_TURNADO_SLOT_INDEX)
        ...
        if self.__isTurnadoTurnedOn == False and turnado_dictator_level != 0.0:
            ...
            plugins.setParamValue(1.0, parameter_id, constants.MASTER_CHANNEL, constants.MIDI_ROUTING_CONTROL_SURFACE_MIXER_SLOT_INDEX)
            self.__isTurnadoTurnedOn = True
        elif self.__isTurnadoTurnedOn == True and turnado_dictator_level == 0.0:
            parameter_id = fl_helper.findParameterByName(constants.MASTER_CHANNEL, "L_" + str(self.__looper_number + 1) + "_TUR_A", constants.MIDI_ROUTING_CONTROL_SURFACE_MIXER_SLOT_INDEX)
            plugins.setParamValue(0.0, parameter_id, constants.MASTER_CHANNEL, constants.MIDI_ROUTING_CONTROL_SURFACE_MIXER_SLOT_INDEX)
            self.__isTurnadoTurnedOn = False
    ...
    def setTurnadoDryWetLevel(self, turnado_dry_wet_level):        
        plugins.setParamValue(turnado_dry_wet_level, constants.TURNADO_DRY_WET_PARAM_INDEX, self.__looper_channel, constants.LOOPER_TURNADO_SLOT_INDEX)
