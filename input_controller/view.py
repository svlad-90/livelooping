...
class View:
    ...
    def setShiftPressedState(self, shift_pressed):
        ...
        plugins.setParamValue(shift_pressed, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def selectFXPage(self, preset_fx_page_id):
        for i in range(4):
            ...
            plugins.setParamValue(value, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def setFXLevel(self, fx_level):
        ...
        plugins.setParamValue(fx_level, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def setFXPresetAvailability(self, fx_preset_id, preset_availability):
        ...
        plugins.setParamValue(preset_availability, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def setFXParameterActivationStatus(self, fx_param_id, activation_status):
        ...
        plugins.setParamValue(activation_status, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def setTurnadoDryWetLevel(self, turnado_dry_wet_level):
        ...
        plugins.setParamValue(turnado_dry_wet_level, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def setTurnadoDictatorLevel(self, turnado_dictator_level):
        ...
        plugins.setParamValue(turnado_dictator_level, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def turnadoOff(self, off_value):
        ...
        plugins.setParamValue(off_value, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
    ...
    def setActiveFXUnit(self, active_fx_unit):
        ...
        plugins.setParamValue(manipulator_value, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
        ...
        plugins.setParamValue(voodoo_finisher_value, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
        ...
        plugins.setParamValue(custom_value, parameter_id, self.__context.main_channel, constants.SYNTH_CONTROL_SURFACE_MIXER_SLOT_INDEX)
